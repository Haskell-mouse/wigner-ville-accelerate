...
amatrix :: (A.RealFloat e, A.IsFloating e, A.FromIntegral Int e, Elt e,Elt (ADC.Complex e), AMF.Numeric e) 
...
amatrix_w :: (A.RealFloat e, A.IsFloating e, A.FromIntegral Int e, Elt e,Elt (ADC.Complex e), AMF.Numeric e) 
  => Acc (Array DIM1 (ADC.Complex e))   -- ^ Data array
  -> Acc (Array DIM1 Int)               -- ^ taumaxs
  -> Acc (Array DIM1 Int)               -- ^ limits 
...
sFunc :: (A.RealFloat e, A.IsFloating e, A.FromIntegral Int e, Elt e,Elt (ADC.Complex e), AMF.Numeric e)
